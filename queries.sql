...
-- Retorna com o valor final apenas as ordens de serviço que estão EM ANDAMENTO
CREATE OR REPLACE VIEW TABELA_OS_EM_ANDAMENTO_COM_VALOR_FINAL AS
SELECT
	COD_ORDEM_SERVICO,
	COD_CLIENTE,
	COD_FUNCIONARIO,
...
JOIN STATUS
ON TABELA_OS_COM_VALOR_FINAL.COD_STATUS = STATUS.COD_STATUS
WHERE TABELA_OS_COM_VALOR_FINAL.COD_STATUS = 1;


-- Retorna com o valor final apenas as ordens de serviço que estão CONCLUIDAS
CREATE OR REPLACE VIEW TABELA_OS_CONCLUIDA_COM_VALOR_FINAL AS
SELECT
	COD_ORDEM_SERVICO,
	COD_CLIENTE,
	COD_FUNCIONARIO,
...
JOIN STATUS
ON TABELA_OS_COM_VALOR_FINAL.COD_STATUS = STATUS.COD_STATUS
WHERE TABELA_OS_COM_VALOR_FINAL.COD_STATUS = 2;


-- Retorna com o valor final apenas as ordens de serviço que estão CANCELADAS
CREATE OR REPLACE VIEW TABELA_OS_CANCELADA_COM_VALOR_FINAL AS
SELECT
	COD_ORDEM_SERVICO,
	COD_CLIENTE,
	COD_FUNCIONARIO,
...
JOIN STATUS
ON TABELA_OS_COM_VALOR_FINAL.COD_STATUS = STATUS.COD_STATUS
WHERE TABELA_OS_COM_VALOR_FINAL.COD_STATUS = 3;


/*
Retorna com o valor final apenas as ordens de serviço que estão EM ANDAMENTO ou 
CONCLUIDAS
*/
CREATE OR REPLACE VIEW TABELA_OS_VALIDA_COM_VALOR_FINAL AS
SELECT
	COD_ORDEM_SERVICO,
	COD_CLIENTE,
	COD_FUNCIONARIO,
...
JOIN STATUS
ON TABELA_OS_COM_VALOR_FINAL.COD_STATUS = STATUS.COD_STATUS
WHERE TABELA_OS_COM_VALOR_FINAL.COD_STATUS IN (1, 2);
...
SELECT * FROM TABELA_OS_COM_VALOR_FINAL
SELECT * FROM TABELA_OS_EM_ANDAMENTO_COM_VALOR_FINAL
SELECT * FROM TABELA_OS_CONCLUIDA_COM_VALOR_FINAL
SELECT * FROM TABELA_OS_CANCELADA_COM_VALOR_FINAL
SELECT * FROM TABELA_OS_VALIDA_COM_VALOR_FINAL
